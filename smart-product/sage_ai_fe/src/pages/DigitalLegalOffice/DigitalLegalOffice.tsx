...
import styles from './DigitalLegalOffice.module.scss'

const DigitalLegalOfficeInner: React.FC = () => {
  ...
  //         `${APPROVAL_SCORE_PREFIX}-${FormDashboardFormType.DloForm}-${submissionId}`
  //       )
  //     : null
      ...
      try {
        const commonFieldsResponse: CommonFieldResponseModal =
          await formsApi.getCommonFields({
            form_type: FormDashboardFormType.DloForm,
  ...
  const header: FormHeaderProps = {
    formTitle: 'Digital Legal Office - Privacy Request',
    formSubtitle: (
      <>
    ...
    breadcrumbs: [
      ...
      {
        text: 'Digital Legal Office',
        href: '/digital-legal-office',
      },
    ],
  }
...
const DigitalLegalOffice: React.FC = () => {
  return (
    <AIFeaturesProvider>
...
export default DigitalLegalOffice
