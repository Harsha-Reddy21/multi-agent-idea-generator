...
from sqlalchemy import Column, Text, ForeignKey, TIMESTAMP, CheckConstraint, Boolean
...
class AIInteractions(Base):
    ...
    __tablename__ = "sage_ai_ai_interactions"
    ...
    __table_args__ = (
        CheckConstraint(
            "ai_feature_type IN ('suggestions', 'enhance_answer', 'data_extracts', 'check_coverage')",
    ...
    feedbacks = relationship("AIFeedback", back_populates="interaction", cascade="all, delete-orphan")
